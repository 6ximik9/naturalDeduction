...
function suggestions(position, range) {
  const greekAlphabet = [
    ...
    {label: '\\epsilon', insertText: 'ϵ', range: range, kind: monaco.languages.CompletionItemKind.Text},
    ...
    {label: '\\phi', insertText: 'ϕ', range: range, kind: monaco.languages.CompletionItemKind.Text},
