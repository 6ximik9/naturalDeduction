export const translations = {
  ...
  UA: {
    ...
    "ax-robinson-4-desc": "Додавання нуля до будь-якого числа дає те саме число",
    "ax-robinson-5-name": "Рекурсія додавання",
    "ax-robinson-5-desc": "Визначає додавання для наступників",
    "ax-robinson-6-name": "Множення на нуль",
    "ax-robinson-6-desc": "Множення будь-якого числа на нуль дає нуль",
    "ax-robinson-7-name": "Рекурсія множення",
    "ax-robinson-7-desc": "Визначає множення для наступників",
    ...
    "expl-and-i": "Потрібна вибрана формула з кон'юнкцією (∧) або дві вибрані формули (∧I).",
    "expl-and-e": "Потрібна вибрана кон'юнкція (∧) (∧E).",
    "expl-or-i": "Потрібна вибрана формула з диз'юнкцією (∨) або формула для введення диз'юнкції (∨I).",
    "expl-or-e": "Потрібна вибрана диз'юнкція (∨) та два піддоведення (∨E).",
    "expl-imp-i": "Потрібна вибрана формула з імплікацією (⇒) або піддоведення (⇒I).",
    "expl-imp-e": "Потрібна вибрана імплікація (⇒) та її антецедент (⇒E).",
    "expl-neg-i": "Потрібна вибрана формула з запереченням (¬) або піддоведення з абсурдом (⊥) (¬I).",
    "expl-neg-e": "Потрібна вибрана формула та її заперечення (¬) (¬E).",
    "expl-bot-e": "Потрібен вибраний абсурд (⊥) (⊥E).",
    "expl-raa": "Потрібна вибрана формула або піддоведення з абсурдом (⊥) (C).",
    "expl-notnot-e": "Потрібне вибране подвійне заперечення (¬¬) (¬¬E).",
    "expl-reit": "Потрібна вибрана формула з доступної області (R).",
    "expl-forall-e": "Потрібен вибраний універсальний квантор (∀) (∀E).",
    "expl-forall-i": "Потрібна вибрана формула з універсальним квантором (∀) або піддоведення (∀I).",
    "expl-exists-i": "Потрібна вибрана формула з квантором існування (∃) або формула φ(t) (∃I).",
    "expl-exists-e": "Потрібна вибрана екзистенційна формула (∃) та піддоведення (∃E).",
    "expl-eq-i": "Потрібна вибрана формула з рівністю (=) або терм (=I).",
    "expl-eq-e": "Потрібна вибрана ідентичність (a = b) та формула (=E).",
    "expl-ax": "Формула має бути в гіпотезах (Γ) або бути відомою аксіомою (Ax).",
    "expl-top-i": "Потрібна вибрана формула з істиною (⊤) (⊤I).",
    "expl-ind": "Потрібен вибраний універсальний квантор (∀) для індукції.",
    "expl-id": "Потрібна спільна формула з обох сторін (id).",
    ...
    "expl-wl": "Потрібна вибрана формула зліва (wl).",
    "expl-wr": "Потрібна вибрана формула справа (wr).",
    "expl-cl": "Потрібна вибрана формула зліва (cl).",
    "expl-cr": "Потрібна вибрана формула справа (cr).",
